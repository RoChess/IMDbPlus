...
namespace IMDb
{
    public static class GUIUtils
    {
        ...
        public static readonly string IMDbLogo = GUIGraphicsContext.Skin + "\\Media\\Logos\\imdb+.png";
        ...
        public static void SetProperty(string property, string value, bool log)
        {
            ...
            if (log)
            {
                if (GUIPropertyManager.Changed)
                    ...
                    Logger.Warning("Set property \"" + property + "\" to \"" + value + "\" failed");
            }
        }
        ...
        {
            ShowNotifyDialog(heading, text, IMDbLogo, GUILocalizeStrings.Get(186), -1);
        }
        ...
        {
            ShowNotifyDialog(heading, text, IMDbLogo, GUILocalizeStrings.Get(186), timeOut);
        }
